...
FX_BACKEND_UNIVERSE = ["EURUSD=X","GBPUSD=X","AUDUSD=X","NZDUSD=X","JPY=X","CHF=X","CAD=X","EURJPY=X","GBPJPY=X","AUDJPY=X","NZDJPY=X","EURGBP=X","EURCHF=X","IDR=X","CNH=X","SGD=X"]
COMMODITIES_BACKEND_UNIVERSE = {"precious":["GC=F","SI=F","PL=F","PA=F"],"energy":["CL=F","BZ=F","NG=F","RB=F","HO=F"],"industrial_metals":["HG=F"],"agri_softs":["ZC=F","ZW=F","ZS=F","KC=F","SB=F","CT=F","CC=F","LE=F","HE=F"],"broad_proxies":["DBC","GSG","DBA","DBB","URA"]}

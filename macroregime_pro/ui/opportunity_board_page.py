...
def render_opportunity_board_page(snapshot: dict) -> None:
    ...
    render_opportunity_table(filtered, 'Master ranked opportunities', cols=['ticker','market','bias','horizon','entry_zone','invalidation','target','countdown_days_left','review_state','next_action','macro_aligned','route_source_label','confidence','ev_score'])

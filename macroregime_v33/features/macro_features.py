...
def build_macro_features(fred: Dict[str, pd.Series], prices: Dict[str, pd.Series], loader_meta: Dict[str, dict] | None = None) -> Dict[str, float]:
    ...
    growth_level = _nanmean_or(growth_inputs, 0.0)
    growth_momentum = _nanmean_or(growth_mom_inputs, 0.0)
    inflation_level = _nanmean_or(inflation_inputs, 0.0)
    ...
    monthly_growth_signal = _nanmean_or(monthly_growth_inputs, 0.0)
    monthly_inflation_signal = _nanmean_or(monthly_inflation_inputs, 0.0)
